"""Preview or execute one bounded APLoop CALL-E call."""
...
from aploop.core import execute, parse_request, preview
...
def parse_args(argv: list[str] | None = None) -> argparse.Namespace:
    ...
    parser.add_argument("--confirm-existing-b2b-invoice", action="store_true")
...
def main(argv: list[str] | None = None) -> int:
    ...
    try:
        ...
        if not args.confirm_existing_b2b_invoice:
            raise ValueError("--execute requires --confirm-existing-b2b-invoice")
